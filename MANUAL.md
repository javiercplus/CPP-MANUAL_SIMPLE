...
## UNBREAKABLE Rules before starting / YOUR CREED
...
It is used so the program takes different paths depending on a condition.
...
} # Essential C++ Manual (2026 Edition)
```
...
// It will be explained in detail in the Vectors section
...
*What are they for? To pass variables to functions without copying them (saving memory) and to create complex data structures.*
